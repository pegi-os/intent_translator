    ...
    <div style={{margin:"20px"}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <select name="context_attributes[0].contextValueRange[0]" value={formData.context_attributes[0].contextValueRange[0]} onChange={(e) => {
            const updatedContextAttributes = [...formData.context_attributes];
            updatedContextAttributes[0].contextValueRange[0] = e.target.value;
            setFormData({ ...formData, context_attributes: updatedContextAttributes });
          }}>
            <option value="">Select Target SDV ID</option>
            <option value="SDV_001">SDV_001</option>
            <option value="SDV_002">SDV_002</option>
          </select>
        </div><br></br>
        <div>
